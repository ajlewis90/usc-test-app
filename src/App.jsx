...
function App() {
  ...
  const mainTabs = [
    ...
    { name: 'Carts', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256"><path d="M184,184a24,24,0,1,1-24-24A24,24,0,0,1,184,184Zm-80-24a24,24,0,1,0,24,24A24,24,0,0,0,104,160Zm128-88V216a16,16,0,1,1-16,16H32a16,16,0,0,1-16-16V72A16,16,0,0,1,32,56H48L72,24A8,8,0,0,1,80,24H176a8,8,0,0,1,8,8Z" /></svg> },
  ];
