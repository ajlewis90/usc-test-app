...
const ShareButton = ({ shareText, shareTitle, productImage }) => {
  ...
  const instagramShareUrl = `https://www.instagram.com/share?url=${shareUrl}&text=${encodedShareText}`; // Instagram share URL
